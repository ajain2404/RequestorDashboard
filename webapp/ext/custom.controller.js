sap.ui.define([
	...
	"com/evonik/xa/common/util/CockpitUtility"
], function (Filter, MessageToast, FilterOperator, CockpitUtility) {
	"use strict";

	// controller for custom filter, navigation param, action(quick view and global filter), navigation target 
	return sap.ui.controller("com.evonik.sc.purchasing.requestorovp.ext.custom", {
		...
		*/
		...
		getCustomAppStateDataExtension: function (oCustomData) {
			if (!this._aParameterMapping) {
				this.populateParameterMapping();
			}
		...
		*/
		...
		populateParameterMapping: function () {

			this._oCockpitUtility = new CockpitUtility();
			this._oCockpitUtility.getAppParameterMapping("SOC_OVP_RQ", "ZSOC_PR", function (aParameterMapping) {
				this._aParameterMapping = aParameterMapping;
			}.bind(this), function () {
				sap.m.MessageToast.show("Error retrieving parameter mapping");
			});
		},
